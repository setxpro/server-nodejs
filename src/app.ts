...
app.post('/user/create', async (req: Request, res: Response) => {
    const { name, middlename, email, login, password, assignments, charge, avatar } = req.body
...
// Credentials
const DB_USER= 'admin';
const DB_PASS= encodeURIComponent('admin')

// database connection

mongoose
    .connect(`mongodb+srv://${DB_USER}:${DB_PASS}@cluster0.gw1meza.mongodb.net/?retryWrites=true&w=majority`)
    .then(() => {
